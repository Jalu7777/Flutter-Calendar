...
await db.execute('CREATE TABLE $table ($id INTEGER PRIMARY KEY AUTOINCREMENT,$title TEXT,$fromDate TEXT,$toDate TEXT,$background TEXT,$colorTitle TEXT,$eventType TEXT)');
}
